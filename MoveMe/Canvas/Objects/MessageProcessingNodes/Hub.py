...
class HubMessageProcessingNode(ConnectableSource, ConnectableDestination, ObjectWithText, ClonableObject, DeletableObject, SelectableObject, MovableObject):
    def __init__(self):
        super(HubMessageProcessingNode, self).__init__()

        self.boundingBoxDimensions = [20, 20]
        self.nodeBackgroundColor = '#EEEEEE'
        HubMessageProcessingNode.shortHumanFriendlyDescription = "Hub"
